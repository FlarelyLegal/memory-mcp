...
<head>
  ...
  <title>Service Token Management</title>
  <style>
...
header h1{font-size:18px;font-weight:600;margin-bottom:.25rem}
header p{color:#666;font-size:13px}
.card{background:#fff;border:1px solid #e0e0e0;border-radius:8px;padding:1.5rem;margin-bottom:1.5rem}
.card h2{font-size:14px;font-weight:600;margin-bottom:1rem}
